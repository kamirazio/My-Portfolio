...
var APP_VIEW= Backbone.View.extend({
  ...
  openModal: function(e){
    ...
    var results = _.where(portfolio_v.col.models, {"id": id});
    // console.log(results);
  ...
  renderChart: function() {
    ...
    ctx1.canvas.width = ctx1.canvas.height
    = ctx2.canvas.width = ctx2.canvas.height
    = ctx3.canvas.width = ctx3.canvas.height = 150;
